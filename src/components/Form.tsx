...
export const Form = () => {
	...
	const contents = (
		<>
			...
			>
				...
				<input 
					type="text" 
					id='name'
					className="rounded text-xl p-2"
					placeholder='zhang san' 
					{...register('name')}
				/>
				{errors.name && 
					<p className='bg-yellow-100 text-red-500 italic px-2 py-2 rounded-md self-start'>
						{errors.name?.message}
					</p>
				}
        ...
        />
				...
				<button 
					type="submit" 
					className="text-3xl bg-gray-300 p-2 rounded-md max-w-[10rem] mt-2"
				>
						Submit
				</button>
			</form>
